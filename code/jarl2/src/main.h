...
// gfx and display constants
#define VIDEO_MODE		SCREEN_WIDTH, SCREEN_HEIGHT, 32, \
						SDL_SWSURFACE | SDL_DOUBLEBUF// | SDL_NOFRAME make ESC exit first, and add shadow?
#define GAME_WIDTH		320
#define GAME_HEIGHT		240
#define TILE_SIDE		16
#define TILE_WIDTH		TILE_SIDE
#define TILE_HEIGHT		TILE_SIDE
...
// specific entity (sub-dungeon) identifiers
#define BLACK_SPACE			751
#define PLAYER				49
#define RAT					192
